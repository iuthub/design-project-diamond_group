...
<style class="anchorjs"></style><link href="/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-9gVQ4dYFwwWSjIDZnLEWnxCjeSWFphJiwGPXr1jddIhOegiu1FwO5qRGvFXOdJZ4" crossorigin="anonymous">
...
<!-- Facebook -->
<meta property="og:url" content="https://getbootstrap.com/docs/4.1/examples/">
...
<script async="" src="https://www.google-analytics.com/analytics.js"></script><script>
  ...
  <script id="_carbonads_projs" type="text/javascript" src="//srv.carbonads.net/ads/CKYIKKJL.json?segment=placement:getbootstrapcom&amp;callback=_carbonads_go"></script></head>
  <body>
  ...
  <div class="navbar-nav-scroll">
    <ul class="navbar-nav bd-navbar-nav flex-row">
      ...
      <li class="nav-item">
        <a class="nav-link " href="/docs/4.1/getting-started/introduction/" onclick="ga('send', 'event', 'Navbar', 'Community links', 'Docs');">Documentation</a>
      </li>
      <li class="nav-item">
  ...
  <div class="pt-md-3 pb-md-4">
    ...
    <a href="https://github.com/twbs/bootstrap/archive/v4.1.0.zip" class="btn btn-lg btn-bd-primary" onclick="ga('send', 'event', 'Examples', 'Hero', 'Download');">Download source code</a>
  </div>
  <script async="" src="https://cdn.carbonads.com/carbon.js?zoneid=1673&amp;serve=C6AILKT&amp;placement=getbootstrapcom" id="_carbonads_js"></script><div id="carbonads"><span><span class="carbon-wrap"><a href="//srv.carbonads.net/ads/click/x/GTND42QLCWBIV2QUCYS4YKQMCVBIV2JICVBDPZ3JCW7DP2JJFTYIEK7KC6BI62QMC6BDVK3EHJNCLSIZ?segment=placement:getbootstrapcom;" class="carbon-img" target="_blank" rel="noopener"><img src="https://cdn4.buysellads.net/uu/1/3332/1524772006-61060.png" alt="" border="0" height="100" width="130" style="max-width: 130px;"></a><a href="//srv.carbonads.net/ads/click/x/GTND42QLCWBIV2QUCYS4YKQMCVBIV2JICVBDPZ3JCW7DP2JJFTYIEK7KC6BI62QMC6BDVK3EHJNCLSIZ?segment=placement:getbootstrapcom;" class="carbon-text" target="_blank" rel="noopener">Start using Asana today, and say goodbye to status meetings and distracting DMs.</a></span><a href="http://carbonads.net/?utm_source=getbootstrapcom&amp;utm_medium=ad_via_link&amp;utm_campaign=in_unit&amp;utm_term=carbon" class="carbon-poweredby" target="_blank" rel="noopener">ads via Carbon</a><img src="https://ad.doubleclick.net/ddm/trackimp/N30602.734586CARBONADS.NET/B10763732.216182610;dc_trk_aid=415000689;dc_trk_cid=98676733;ord=152551521;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=?" border="0" height="1" width="1" style="display: none;"></span></div>

</header>

<main class="bd-content p-5" id="content" role="main">
  
  <h2 id="custom-components"><div>Custom components<a class="anchorjs-link " href="#custom-components" aria-label="Anchor" data-anchorjs-icon="#" style="padding-left: 0.375em;"></a></div></h2>
    ...
    <div class="row">
      <div class="col-sm-6 col-md-4 col-xl-3 mb-3">
        <a href="/docs/4.1/examples/album/">
          <img class="img-thumbnail mb-3" src="/docs/4.1/examples/screenshots/album.png" alt="Album screenshot" width="960" height="600">
  ...
  <h2 id="framework"><div>Framework<a class="anchorjs-link " href="#framework" aria-label="Anchor" data-anchorjs-icon="#" style="padding-left: 0.375em;"></a></div></h2>
    ...
    <div class="row">
      <div class="col-sm-6 col-md-4 col-xl-3 mb-3">
        <a href="/docs/4.1/examples/starter-template/">
          <img class="img-thumbnail mb-3" src="/docs/4.1/examples/screenshots/starter-template.png" alt="Starter template screenshot" width="960" height="600">
  ...
  <h2 id="navbars"><div>Navbars<a class="anchorjs-link " href="#navbars" aria-label="Anchor" data-anchorjs-icon="#" style="padding-left: 0.375em;"></a></div></h2>
    ...
    <div class="row">
      <div class="col-sm-6 col-md-4 col-xl-3 mb-3">
        <a href="/docs/4.1/examples/navbars/">
          <img class="img-thumbnail mb-3" src="/docs/4.1/examples/screenshots/navbars.png" alt="Navbars screenshot" width="960" height="600">
  ...
  <h2 id="experiments"><div>Experiments<a class="anchorjs-link " href="#experiments" aria-label="Anchor" data-anchorjs-icon="#" style="padding-left: 0.375em;"></a></div></h2>
  <p>Examples that focus on future-friendly features or techniques.</p>
  
    <div class="row">
      <div class="col-sm-6 col-md-4 col-xl-3 mb-3">
        <a href="/docs/4.1/examples/floating-labels/">
          <img class="img-thumbnail mb-3" src="/docs/4.1/examples/screenshots/floating-labels.png" alt="Floating labels screenshot" width="960" height="600">
  ...
  <div class="container-fluid p-3 p-md-5">
    ...
    <p>Currently v4.1.0. Code licensed <a href="https://github.com/twbs/bootstrap/blob/master/LICENSE" target="_blank" rel="license noopener">MIT</a>, docs <a href="https://creativecommons.org/licenses/by/3.0/" target="_blank" rel="license noopener">CC BY 3.0</a>.</p>
  </div>
</footer>
